...
public class EntryButtonWidget extends AbstractButtonWidget {
    ...
    public Component getNarrationMessage(){
        ...
        if(item == null)
            return null;
        return TextComponents.translation("rechiseledae.chiseling_pattern_encoder.select_block", TextComponents.item(item.item()).get()).get();
    }
